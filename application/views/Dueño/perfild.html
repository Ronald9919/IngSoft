            ...
            <ul id="slide-out" class="sidenav">
                <li>
                    <ul class="collapsible">
                        ...
                        <li>
                            <a href="perfild.html" class="collapsible-header"><i class="material-icons">person</i><span class="hide-menu"> Ver perfil </span></a>
                        </li>
                        <li class="small-cap"><span class="hide-menu">Taller</span></li>
                        <li>
                            <a href="ingresart.html" class="collapsible-header"><i class="material-icons">add</i><span class="hide-menu"> Registrar taller </span></a>
                        </li>
                        <li>
                            <a href="perfilt.html" class="collapsible-header"><i class="material-icons">business_center</i><span class="hide-menu"> Perfil del taller </span></a>
                        </li>
                        <li>
                            <a href="catalogo.html" class="collapsible-header"><i class="material-icons">build</i><span class="hide-menu"> Catalogo de talleres </span></a>
                        </li>
                    </ul>
                </li>
            </ul>
